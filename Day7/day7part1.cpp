...
/*   Updated: 2020/12/07 22:45:07 by tbruinem      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	splitters.push_back(" bags contain ");
	splitters.push_back(" bag,");
	splitters.push_back(" bags,");
	splitters.push_back(" bag.");
	splitters.push_back(" bags.");
	while (!cin.eof())
	{
...
//			std::cout << "\t" << jt->first << " " << jt->second << std::endl;
	...
	std::cout << total_bags - 1 << std::endl;
	return (0);
}
